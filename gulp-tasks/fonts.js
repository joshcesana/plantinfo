...
const fonts = async () => {
  ...
  return result = await instance.download(
    'https://fonts.googleapis.com/css2?family=Cardo:ital,wght@0,400;0,700;1,400&family=Arimo:ital,wght@0,400;0,700;1,400;1,700&display=swap'
  );
};
